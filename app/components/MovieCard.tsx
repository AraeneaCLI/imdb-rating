...
export function MovieCard({
  ...
  }, [isLoading, plot, rating, year, cast, reviews]);
    ...
    <div className="flex flex-col gap-10 p-4 md:p-8">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight font-serif">
            {title || "Unknown Title"}
          </h2>
        ...
        <div className="space-y-6 pt-8 border-t border-white/10">
          ...
          >
            {reviews.map((review, index) => (
              <div
                key={index}
                className="review-card bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/[0.08] transition-colors group"
              >
                <div className="flex items-start gap-4">
                  <span className="text-purple-400 text-3xl font-serif leading-none opacity-40 group-hover:opacity-100 transition-opacity">
                    &ldquo;
                  </span>
